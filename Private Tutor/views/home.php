          ...
          <div class="row">
            ...
            <div class="col-xl-10 col-lg-8 col-md-8 col-sm-9">
              <div class="header_information">
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li> <a href="courseInformation.php">My Courses </a> </li>
                      <li> <a href="#about">About</a> </li>
                      <li> <a href="studentList.php">My Profile</a> </li>
               ...
               <div class="mean-last">
                       <a href="#"><img src="images/search_icon.png" alt="#" /></a> <a href="signup.php">login/sing up</a></div>              
             </div>
           </div>
         </div>
       </div>
